...
gulp.task('watch', ['browserSync', 'sass', 'scripts', 'images', 'fileinclude', 'html'], function (){
...
gulp.task('default', function (callback) {
  runSequence(['clean:dist', 'sass', 'images', 'fileinclude', 'scripts', 'useref', 'html', 'browserSync', 'watch'],
    callback
  )
})
